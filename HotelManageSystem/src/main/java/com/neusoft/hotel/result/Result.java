...
public class Result<T> {
	...
	private List<T> list=null; //接受返回多个的Model对象
	private int intResult=0;
	private String stringResult=null;
	private double doubelResult=0;
	...
	private String message=null;//返回操作的消息
	...
	public double getDoubelResult() {
		return doubelResult;
	}
	public void setDoubelResult(double doubelResult) {
		this.doubelResult = doubelResult;
	}
